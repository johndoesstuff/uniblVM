...
syntax keyword uniblInstruction HALT LDA STA SWP JMP JMPBZ ADDAB SUBAB CMPAB VOID NANDAB
...
syntax keyword uniblDefinition CALLSTACK STACK P_STDIN P_STDOUT P_CALLSTACK P_STACK CALLSTACK_SIZE STACK_SIZE RETURN STDIN STDOUT
